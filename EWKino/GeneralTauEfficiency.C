...
void SetBranches(TString FileName){
    TFile * inFile = new TFile("/user/lwezenbe/private/PhD/Trees/" + FileName +".root", "read");

    inFile->GetObject("blackJackAndHookers/blackJackAndHookersTree", Tree);
...
void GeneralTauEfficiency(){
    ...
    for(Long64_t entry = 0; entry < nentry; entry++){                               //Loop over all entries
        ...
        for(int lepton = 0; lepton < _nL; lepton++){                                //Loop over all leptons in event
            ...
            for(int discriminator = 0; discriminator < NumberOfDiscr; discriminator++){
                if(discriminator == VLoose_Old and _lPOGVeto[lepton]){                  EfficiencyHistMVA->Fill(.5); EfficiencyPtHist[discriminator][Enumerator]->Fill(_lPt[lepton]); EfficiencyEtaHist[discriminator][Enumerator]->Fill(_lEta[lepton]);}                 //Old tau ID
                if(discriminator == Loose_Old and _lPOGLoose[lepton]){                  EfficiencyHistMVA->Fill(1.5); EfficiencyPtHist[discriminator][Enumerator]->Fill(_lPt[lepton]); EfficiencyEtaHist[discriminator][Enumerator]->Fill(_lEta[lepton]);}
                if(discriminator == Medium_Old and _lPOGMedium[lepton]){                EfficiencyHistMVA->Fill(2.5); EfficiencyPtHist[discriminator][Enumerator]->Fill(_lPt[lepton]); EfficiencyEtaHist[discriminator][Enumerator]->Fill(_lEta[lepton]);}
                if(discriminator == Tight_Old and _lPOGTight[lepton]){                  EfficiencyHistMVA->Fill(3.5); EfficiencyPtHist[discriminator][Enumerator]->Fill(_lPt[lepton]); EfficiencyEtaHist[discriminator][Enumerator]->Fill(_lEta[lepton]);}
                if(discriminator == VTight_Old and _tauVTightMvaOld[lepton]){           EfficiencyHistMVA->Fill(4.5); EfficiencyPtHist[discriminator][Enumerator]->Fill(_lPt[lepton]); EfficiencyEtaHist[discriminator][Enumerator]->Fill(_lEta[lepton]);}

                if(discriminator == VLoose_New and _tauVLooseMvaNew[lepton]){           EfficiencyHistMVA->Fill(5.5); EfficiencyPtHist[discriminator][Enumerator]->Fill(_lPt[lepton]); EfficiencyEtaHist[discriminator][Enumerator]->Fill(_lEta[lepton]);}                    //New tau ID
                if(discriminator == Loose_New and _tauLooseMvaNew[lepton]){             EfficiencyHistMVA->Fill(6.5); EfficiencyPtHist[discriminator][Enumerator]->Fill(_lPt[lepton]); EfficiencyEtaHist[discriminator][Enumerator]->Fill(_lEta[lepton]);}
                if(discriminator == Medium_New and _tauMediumMvaNew[lepton]){           EfficiencyHistMVA->Fill(7.5); EfficiencyPtHist[discriminator][Enumerator]->Fill(_lPt[lepton]); EfficiencyEtaHist[discriminator][Enumerator]->Fill(_lEta[lepton]);}
                if(discriminator == Tight_New and _tauTightMvaNew[lepton]){             EfficiencyHistMVA->Fill(8.5); EfficiencyPtHist[discriminator][Enumerator]->Fill(_lPt[lepton]); EfficiencyEtaHist[discriminator][Enumerator]->Fill(_lEta[lepton]);}
                if(discriminator == VTight_New and _tauVTightMvaNew[lepton]){           EfficiencyHistMVA->Fill(9.5); EfficiencyPtHist[discriminator][Enumerator]->Fill(_lPt[lepton]); EfficiencyEtaHist[discriminator][Enumerator]->Fill(_lEta[lepton]);}
                
                if(discriminator == VVLoose_Cut and _tauCombinedIsoDBRaw3Hits[lepton] < 4.5){              EfficiencyHistCuts->Fill(.5); EfficiencyPtHist[discriminator][Enumerator]->Fill(_lPt[lepton]); EfficiencyEtaHist[discriminator][Enumerator]->Fill(_lEta[lepton]);}                    //Cut-based
                if(discriminator == VLoose_Cut and _tauCombinedIsoDBRaw3Hits[lepton] < 3.5){               EfficiencyHistCuts->Fill(1.5); EfficiencyPtHist[discriminator][Enumerator]->Fill(_lPt[lepton]); EfficiencyEtaHist[discriminator][Enumerator]->Fill(_lEta[lepton]);}
                if(discriminator == Loose_Cut and _tauCombinedIsoDBRaw3Hits[lepton] < 2.0){                EfficiencyHistCuts->Fill(2.5); EfficiencyPtHist[discriminator][Enumerator]->Fill(_lPt[lepton]); EfficiencyEtaHist[discriminator][Enumerator]->Fill(_lEta[lepton]);}
                if(discriminator == Medium_Cut and _tauCombinedIsoDBRaw3Hits[lepton] < 1.0){               EfficiencyHistCuts->Fill(3.5); EfficiencyPtHist[discriminator][Enumerator]->Fill(_lPt[lepton]); EfficiencyEtaHist[discriminator][Enumerator]->Fill(_lEta[lepton]);}
                if(discriminator == Tight_Cut and _tauCombinedIsoDBRaw3Hits[lepton] < 0.8){                EfficiencyHistCuts->Fill(4.5); EfficiencyPtHist[discriminator][Enumerator]->Fill(_lPt[lepton]); EfficiencyEtaHist[discriminator][Enumerator]->Fill(_lEta[lepton]);}
...
//Draw
    ...
    EfficiencyHistMVA->Draw("EHIST");
    // CMS_lumi(c1, 4, 1);
    c1->SaveAs("/user/lwezenbe/private/PhD/Results/TauStudy/EWKino/"+FileName+"/TauEwkinoEfficiencyMVA.pdf");
    delete c1;
    ...
    // CMS_lumi(c1, 4, 1);
    c12->SaveAs("/user/lwezenbe/private/PhD/Results/TauStudy/EWKino/"+FileName+"/TauEwkinoEfficiencyCuts.pdf");
    delete c12;
    ...
    legend->Draw();
    CMS_lumi(c2, 4, 11);
    c2->SaveAs("/user/lwezenbe/private/PhD/Results/TauStudy/EWKino/"+FileName+"/OldMVATauEwkinoEfficiencyAsFuncOfPT.pdf");
    delete c2;
    ...
    legend1->Draw();
    CMS_lumi(c3, 4, 11);
    c3->SaveAs("/user/lwezenbe/private/PhD/Results/TauStudy/EWKino/"+FileName+"/NewMVATauEwkinoEfficiencyAsFuncOfPT.pdf");
    delete c3;
    ...
    legend2->Draw();
    CMS_lumi(c4, 4, 11);
    c4->SaveAs("/user/lwezenbe/private/PhD/Results/TauStudy/EWKino/"+FileName+"/OldMVATauEwkinoEfficiencyAsFuncOfETA.pdf");
    delete c4;
    ...
    legend3->Draw();
    CMS_lumi(c5, 4, 11);
    c5->SaveAs("/user/lwezenbe/private/PhD/Results/TauStudy/EWKino/"+FileName+"/NewMVATauEwkinoEfficiencyAsFuncOfETA.pdf");
    delete c5;
    ...
    legend12->Draw();
    CMS_lumi(c6, 4, 11);
    c6->SaveAs("/user/lwezenbe/private/PhD/Results/TauStudy/EWKino/"+FileName+"/CUTTauEwkinoEfficiencyAsFuncOfPT.pdf");
    delete c6;
    ...
    legend22->Draw();
    CMS_lumi(c7, 4, 11);
    c7->SaveAs("/user/lwezenbe/private/PhD/Results/TauStudy/EWKino/"+FileName+"/CUTTauEwkinoEfficiencyAsFuncOfETA.pdf");
    delete c7;
