...
void MisIDLeptons(){
    ...
    cout << nPromptTaus << " " << EfficiencyHist->GetBinContent(2) << endl;
...
//Draw
    ...
    // CMS_lumi(c1, 4, 1);
    c1->SaveAs("/user/lwezenbe/private/PhD/Results/TauStudy/EWKino/"+FileName+"/MisID/TauEwkinoLeptonDiscr.pdf");
    delete c1;
    ...
    legend->Draw();
    CMS_lumi(c2, 4, 11);
    c2->SaveAs("/user/lwezenbe/private/PhD/Results/TauStudy/EWKino/"+FileName+"/MisID/TauEwkinoLeptonDiscrAsFuncOfPT.pdf");
    delete c2;
    ...
    legend1->Draw();
    CMS_lumi(c3, 4, 11);
    c3->SaveAs("/user/lwezenbe/private/PhD/Results/TauStudy/EWKino/"+FileName+"/MisID/TauEwkinoLeptonDiscrAsFuncOfEta.pdf");
    delete c3;
