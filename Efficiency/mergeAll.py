...
mergeEfficiency(['DYJets'], 'Default')
mergeEfficiency(['WZ'], 'Default')
mergeFakeRate(['QCD'], 'Default')
mergeFakeRate(['TT'], 'Default')
mergeFakeRate(['DYJets'], 'Default')
mergeFakeRate(['WJets'], 'Default')
