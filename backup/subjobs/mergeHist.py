...
samplesToMergeLocation = ["DYJets", "ST", "TT", "VV", "WJets", "QCD", "SingleMuon"]

for name in samplesToMergeLocation:
    for var in varNames:
        hist = []
        listOfFiles = glob.glob("/user/lwezenbe/private/PhD/Results/TauStudy/RecoZmass/Histos/"+name+"/"+ var + "_Hist*.root")
        ...
        mergedHist.SaveAs("/user/lwezenbe/private/PhD/Results/TauStudy/RecoZmass/Histos/Merged/"+name+"/"+var+".root")
