...
const int       NumberOfPromptCateg = 2;

const int       MVA_Old = 0;                    //Different discriminators
const int       MVA_New = 1;
const int       Cut_based = 2;

const int       VLoose_MVA = 0;                  //MVA Discriminator WP
const int       Loose_MVA = 1;
const int       Medium_MVA = 2;
const int       Tight_MVA = 3;
const int       VTight_MVA = 4;

const int       VVLoose_Cut = 0;                 //Cut based WP                   
...
const int       Prompt = 0;
const int       NonPrompt = 0;

const int       NumberOfSignalSamples = 1;    // chain->SetBranchAddress("_metRawPhi", &_metRawPhi, &b__metRawPhi);

const int       NumberOfBkgrSamples = 1;

TChain * chain;                                         

TString SignalSamples[NumberOfSignalSamples] = {"/pnfs/iihe/cms/store/user/lwezenbe/heavyNeutrino/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/crab_Moriond2017_ext1-v2_tauSamples/181212_134538/0000/"};
//TString BkgrSamples[NumberOfBkgrSamples] = {"/pnfs/iihe/cms/store/user/lwezenbe/heavyNeutrino/QCD_HT100to200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/crab_Moriond2017-v1_tauSamples/181210_114028/0000/", "/pnfs/iihe/cms/store/user/lwezenbe/heavyNeutrino/QCD_HT200to300_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/crab_Moriond2017-v1_tauSamples/181210_114103/0000/", "/pnfs/iihe/cms/store/user/lwezenbe/heavyNeutrino/QCD_HT300to500_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/crab_Moriond2017-v1_tauSamples/181210_114135/0000/", "/pnfs/iihe/cms/store/user/lwezenbe/heavyNeutrino/QCD_HT500to700_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/crab_Moriond2017-v1_tauSamples/181210_114212/0000/", "/pnfs/iihe/cms/store/user/lwezenbe/heavyNeutrino/QCD_HT700to1000_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/crab_Moriond2017-v1_tauSamples/181210_114251/0000/"};
TString BkgrSamples[NumberOfBkgrSamples] = {"/pnfs/iihe/cms/store/user/lwezenbe/heavyNeutrino/QCD_HT100to200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/crab_Moriond2017-v1_tauSamples/181210_114028/0000/"};

TString discriminatorNames[3] = {"OldMVA", "NewMVA", "CutBased"};
TString WPNames[5] = {"VLoose", "Loose", "Medium", "Tight", "VTight"};

Double_t    nentry = 0;
Double_t    nTaus[NumberOfPromptCateg] = {0};

Double_t Efficiency[NumberOfPromptCateg][NumberOfDiscr][NumberOfWP] = {0};                  //Define efficiency containers
Double_t EfficiencyErrors[NumberOfPromptCateg][NumberOfDiscr][NumberOfWP] = {0};
TH1D* EfficiencyPtHistNum[NumberOfPromptCateg][NumberOfDiscr][NumberOfWP];
Double_t PtHistLimits[NumberOfPromptCateg] = {120, 300};
TH1D* EfficiencyEtaHistNum[NumberOfPromptCateg][NumberOfDiscr][NumberOfWP];
TH1D* EfficiencyPtHistDenom[NumberOfPromptCateg];
TH1D* EfficiencyEtaHistDenom[NumberOfPromptCateg];

const int NumberOfSignalVar = 10;
const int lpt = 0;
const int leta = 1;
const int lE = 2;
const int dxy = 3;
const int dz = 4;
const int reliso = 5;
const int tauAgainstElectronMVA6Raw = 6;
const int tauCombinedIsoDBRaw3Hits = 7;
const int ptRel = 8;
const int ptRatio = 9;

const int NumberOfBkgrVar = 4;
const int jetpt = 0;
const int jeteta = 1;
const int jetE = 2;
const int jetCsvV2 = 3;

TH1D* SignalVarHist[10];
TH1D* BkgrVarHist[4];

TString SignalVarNames[10] = {"lPt", "lEta", "lE", "dxy", "dz", "relIso", "tauAgainstElectronMVA6Raw", "tauCombinedIsoDBRaw3Hits", "ptRel", "ptRatio"};
TString BkgrVarNames[4] = {"jetPt", "jetEta", "jetE", "jetCsvV2"};
...
Bool_t          _tauDecayMode[8];   //[_nL]
Bool_t          _decayModeFinding[8];   //[_nL]
...
Double_t        _lMatchPt[8];
Double_t        _lMatchEta[8];
Double_t        _lMatchPhi[8];
Double_t        _lMatchE[8];
